...
public static class RectTransformExtension
{
    public static void ReScaleImageIntoRectTransform(this RectTransform imageRect, RectTransform containerTransform)
    {
        ...
        if (widthDifference > 0 || heightDifference > 0)
        {
            ...
            {
                imageRect.sizeDelta = imageRect.rect.size * (containerTransform.rect.size.y / imageRect.rect.size.y);
            }
            else
            {
                imageRect.sizeDelta = imageRect.rect.size * (containerTransform.rect.size.x / imageRect.rect.size.x);
            }
        }
    }
}
